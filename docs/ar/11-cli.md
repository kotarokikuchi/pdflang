...
ولا يعتمد على شيء البتة — لا CDN ولا أداة تجميع ولا خادم. افتح الملف، أو اضغط
المجلد وأرسله إلى من عليه اعتماد إعادة الطبع.

ثلاث طرق للنظر إلى الزوج نفسه:

- **Wipe** — اسحب فوق الصفحة لتكنس الملف الجديد فوق القديم. أسرع وسيلة لمعرفة
  إن كان شيء قد انتقل.
- **Flip** — اضغط بالمؤشر لتبديل الاثنين في مكانهما. ما تحرّك يقفز، وما ثبت لا.
- **Fade** — يمزج الاثنين، ويفيد في الحكم على تغيّر لون أو وزن.

وفوق أي منها تُلوَّن الفروق في مكانها، ويقول اللون نوعها:

| اللون | المعنى |
|---|---|
| أحمر | حبر اختفى من الملف الجديد |
| أخضر | حبر جديد فيه |
| أزرق | الوزن نفسه بلون آخر |

والمنزلق بجانب **Differences** يُخفت تلك الطبقة، لتتفقّد الصفحة تحتها دون مغادرة
العارض. و`←` و`→` تنقلان بين الصفحات، و`space` يبدّل، و`d` يشغّل الطبقة ويطفئها.

و**Pages** يرشّح الشريط في الأسفل: **All** أو **Changed only**. ففي مستند من
مئتي صفحة تحرّكت منها ثلاث، يكون المرور على السبع والتسعين بعد المئة الباقية هو
الجزء البطيء من العمل. وتتبع الأسهم هذا الترشيح — تتخطّى ما يخفيه الشريط بدل أن
تقف عليه — والانتقال إلى *Changed only* وأنت على صفحة لم تتغيّر ينقلك إلى أقرب
صفحة تغيّرت. وإن لم يختلف شيء قال الزرّ ذلك وبقي معطّلًا، بدل أن يرشّح الشريط
إلى لا شيء.
