...
Complete guide to the `.pdfl` language and the `pdfl` CLI — version 0.13.0.
...
| [11. CLI commands](11-cli.md) | `run`, `compare`, `watch`, `fix`, `inspect`, `lint`, `fmt`, `doc`, `pack`, `add`, `test`, `completions` |
