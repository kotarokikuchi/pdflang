...
ついてきます。2本が交わる点が、現れている領域の角です。丸印は縦のバーの
その高さに乗るので、ポインタが押さえている場所を指します。
...
大きさだからです。バーの太さも丸印の大きさも、影も含めてどのズームでも変わりません。**Reset view** は
ズームをページ全体に、バーを最初の位置に戻します。戻すものが何もないあいだ、
このボタンは無効です。
